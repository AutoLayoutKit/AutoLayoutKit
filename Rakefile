namespace :test do
  desc "Run the AutoLayoutKit Tests for iOS"
  task :ios do
    $ios_success = system("xctool -workspace Example/LayoutKitPrototype.xcworkspace -scheme 'LayoutKitPrototype' -sdk iphonesimulator test -test-sdk iphonesimulator")
  end
end
